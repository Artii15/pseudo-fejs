...
object CommentsControls {
  ...
  val DISPLAY_COMMENT_ACTION_ID = 3
  val EXIT_ACTION_ID = 4
  ...
  val menu = Menu(List(
    ...
    Action(ActionIntId(CommentsControls.DISPLAY_COMMENT_ACTION_ID), s"$DISPLAY_COMMENT_ACTION_ID - Display comment"),
